...
wget -P /usr/local/src http://mirrors.ustc.edu.cn/mysql-ftp/Downloads/MySQL-5.7/mysql-5.7.25-linux-glibc2.12-x86_64.tar
...
/usr/local/mysql-5.7.25/scripts/mysql_install_db --basedir=/usr/local/mysql-5.7.25/ --datadir=/usr/local/mysql-5.7.25/data/ --user=mysql
